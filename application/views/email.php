                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                        <tr>
                            <td align="center" bgcolor="#C9EEF2" style="padding: 40px 0 30px 0;">
                                <img src="cid:banner_melhor_parceiro.png" alt="Banner NextoYou" width="300" height="80" style="display: block;" />
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="padding: 20px 0 30px 0; color: #F0F2F0; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
											...
											Caso possua alguma duvida ou sugestão, nos envie uma email no seguinte endereço: <b>teste@teste.com</b>.
                                        </td>
                                    </tr>
                                </table>
                            </td>
